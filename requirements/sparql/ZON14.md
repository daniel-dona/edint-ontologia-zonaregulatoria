...
SELECT ?zona ?tipoZona ?referenciaLegal
WHERE {
...
SELECT ?zona ?tipoZona ?nombreZona ?referenciaLegal
WHERE {
    ?zona rdf:type ?tipoZona .
    ?tipoZona rdfs:subClassOf* edintzone:RegulatedZone .
    ?zona edintzone:legalReference ?referenciaLegal .
...
SELECT ?zona ?tipoZona ?nombreZona ?referenciaLegal ?fechaInicio ?fechaFin
WHERE {
    ?zona rdf:type ?tipoZona .
    ?tipoZona rdfs:subClassOf* edintzone:RegulatedZone .
    ?zona edintzone:legalReference ?referenciaLegal .

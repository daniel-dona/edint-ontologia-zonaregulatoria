...
Para manejar las incidencias o mejoras sugeridas con respecto a la ontología, recomendamos seguir las guía proporcionadas en ([Issues Management](./ISSUES.md)) para generar una indicencia (trabajo en progreso).
